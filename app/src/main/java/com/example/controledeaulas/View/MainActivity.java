...
public class MainActivity extends AppCompatActivity
    ...
    Menu menu;
    MenuItem navSegunda, navTerca, navQuarta, navQuinta, navSexta;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_segunda) {


        } else if (id == R.id.nav_terca) {


        } else if (id == R.id.nav_quarta) {

        } else if (id == R.id.nav_quinta) {

        } else if (id == R.id.nav_sexta) {
